...
class DetailScoreStudentPage extends StatefulWidget {
  DetailScoreStudentPage(
      {super.key, required this.data, required this.monthly});
  ScoreStudentModels data;
  final String? monthly;

  @override
  State<DetailScoreStudentPage> createState() => _DetailScoreStudentPageState();
}

class _DetailScoreStudentPageState extends State<DetailScoreStudentPage> {
  @override
